...
| Field | Value |
|---|---|
| **Service ID** | `team-tracker` |
| **Status** | Active |
| **Owner** | Alex Corvin (@accorvin) |
| **Platform Lead** | Saiesh Prabhu (@saprabhu05) |
| **Consumption Model** | Self-Service |
| **Consumers (Roles)** | Individual Contributors, Team Leads, Managers, Directors |
| **Consumers (Teams)** | RHAI Engineering, RHAI Platform |
...
4. Select **Team Tracker** from the sidebar navigation
