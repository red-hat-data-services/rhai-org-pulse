  ...
  <div class="space-y-1 text-xs">
    <template v-if="productBugs.length">
      <template v-for="issue in productBugs" :key="issue.id">
        <span :title="productBugTooltip(issue)" class="block font-semibold text-gray-600 dark:text-gray-300">
          <a
...
const productBugs = computed(() => props.findings.filter(isVisibleProductBug))
