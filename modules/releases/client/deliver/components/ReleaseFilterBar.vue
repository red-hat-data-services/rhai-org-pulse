<template>
  <div class="flex flex-wrap items-center gap-3">
    ...
    <!-- Project Filter (only shown when project filtering is enabled) -->
    <div v-if="hasProjectFilter" class="relative z-20">
      <button
        class="inline-flex items-center gap-2 rounded-lg border px-3 py-2 text-sm font-medium transition-colors"
    ...
    <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
      ...
      <button
        v-if="selectedVersions.size || (selectedProjects && selectedProjects.size)"
...
const props = defineProps({
  ...
  selectedProjects: { type: Set, default: null },
  visibleProjects: { type: Array, default: () => [] },
  ...
  toggleProject: { type: Function, default: null },
  clearProjects: { type: Function, default: null },
  resetFilters: { type: Function, required: true }
})

const hasProjectFilter = computed(() => props.selectedProjects !== null)
