...
export const viewOwners = {
  ...
  'product-builds/overview':                       { name: 'Giulia Naponiello', email: '35328841+gnaponie@users.noreply.github.com' },
  ...
  'product-builds/series-detail':                  { name: 'Giulia Naponiello', email: '35328841+gnaponie@users.noreply.github.com' },
  'product-builds/wheel-collections':              { name: 'Pavol Pitonak', email: 'pavol@pitonak.com' },

  // releases
  'releases/audit':                                { name: 'Alex Corvin', email: 'acorvin@redhat.com' },
  'releases/deliver':                              { name: 'Alex Corvin', email: 'acorvin@redhat.com' },
  'releases/execute':                              { name: 'Alex Corvin', email: 'acorvin@redhat.com' },
  'releases/feature-detail':                       { name: 'shuels2', email: '162622588+shuels2@users.noreply.github.com' },
  ...
  'releases/schedule':                             { name: 'Paul McCarthy', email: 'paul-mccarthy1@hotmail.com' },

  // system-health
  'system-health/component-maturity':              { name: 'Dana Gutride', email: '7306953+dgutride@users.noreply.github.com' },
  'system-health/disconnected-repo-detail':        { name: 'Ajay Jaganathan', email: '36824134+AjayJagan@users.noreply.github.com' },
  'system-health/quality-analysis':                { name: 'Dana Gutride', email: '7306953+dgutride@users.noreply.github.com' },
  ...
  // upstream-pulse
  'upstream-pulse/dashboard':                      { name: 'Dipanshu Gupta', email: '97534722+dpanshug@users.noreply.github.com' },
  'upstream-pulse/insights':                       { name: 'Dipanshu Gupta', email: 'dipgupta@redhat.com' },
  'upstream-pulse/org-detail':                     { name: 'Dipanshu Gupta', email: '97534722+dpanshug@users.noreply.github.com' },
  'upstream-pulse/portfolio':                      { name: 'Dipanshu Gupta', email: 'dipgupta@redhat.com' },
  'upstream-pulse/project-detail':                 { name: 'Dipanshu Gupta', email: '97534722+dpanshug@users.noreply.github.com' },
  ...
  // releases > execute
  'releases/execute/feature-list':                 { name: 'Alex Corvin', email: 'acorvin@redhat.com' },
  'releases/execute/feature-status':               { name: 'Saiesh Prabhu', email: 'saprabhu@redhat.com' },
  ...
  'releases/plan/feature-readiness':               { name: 'Erle Marion', email: '59747212+emarion1@users.noreply.github.com' },
  'releases/plan/outcomes':                        { name: 'Erle Marion', email: '59747212+emarion1@users.noreply.github.com' },
  ...
  'system-health/component-maturity/disconnected': { name: 'Ajay Jaganathan', email: '36824134+AjayJagan@users.noreply.github.com' },
  ...
  'releases/reports/feature-pressure':             { name: 'Dimitri Saridakis', email: 'dimitri.saridakis@gmail.com' },
  ...
  'releases/reports/tv-fv-delta':                  { name: 'Dimitri Saridakis', email: 'dimitri.saridakis@gmail.com' },
